Hej Haslam og Censor

Velkommen til FindDinFilm.dk projektets repository. 
Dette projekt anvender en API forbindelse til at indsamle data om tilgængelige film (og serier) på diverse streaming tjenester.
